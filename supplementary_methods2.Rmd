...
First we set keywords, we selected three different languages worldwide through a time span from 2004 to the present day[^supplementary_methods2-1]:

[^supplementary_methods2-1]: Note that if you run this code after a while, it will automatically update to the latest result, thus it might differ from the paper.
